      ...
      <div class="col-md-12">
		...
		<BR>
			<div class="panel panel-default">
			  <div class="panel-heading" style="background-color: #384452;">
			  	<h4 style="color: white"><i class="fa fa-pencil"></i> Edit Data user</h4>
			  </div>
			  ...
			  <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
			  		...
			  		<div class="form-group">
			  			<button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</span></button>
